  ...
  if (cart.length === 0) {
    return (
      <div className="carrito-vacio">
        ...
        <img
          src="https://res.cloudinary.com/dbaqismy5/image/upload/v1669756075/Stock%20Stickers%20Anime/carrito-vacio_f5bphb.jpg"
          alt=""
        />
  ...
  return (
    <div className="cart">
      ...
      <section className="checkout-cart">
        <h3 className="parrafo-cart">Total: ${totalPrice()}</h3>
