  ...
  return (
    <>
      <nav className="navbar">
        <Link to={"/"}>
          <img
            src="https://res.cloudinary.com/dbaqismy5/image/upload/v1668037022/Stock%20Stickers%20Anime/icono_w4f2wz.webp"
            alt="logo"
        ...
        <ul className={mobileMenu ? "menu" : "menu-expanded"}>
          ...
          <li>
            ...
            <ul className="sub-menu">
              <li>
                <NavLink to="/catagorias/kimetsuNoYaiba">
                  Kimetsu no Yaiba
                </NavLink>
              </li>
              <li>
        ...
        <span className="mobileIcon" onClick={() => setMobileMenu(!mobileMenu)}>
          <MdTableRows />
        </span>
      </nav>
    </>
